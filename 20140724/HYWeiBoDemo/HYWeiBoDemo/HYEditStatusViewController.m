...
- (void)viewDidLoad
{
    ...
    _kbTopBarView = [[UIToolbar alloc] initWithFrame:CGRectMake(0, 568, 320, 44)];
    _kbTopBarView.backgroundColor = [UIColor purpleColor];
...
- (void)createKeyboardTopBarItems
{
    ...
    [_kbTopBarView setItems:@[cameraItem, flexSpaceItem, photoItem, flexSpaceItem, atContactItem, flexSpaceItem, emotionItem, flexSpaceItem, addItem]];
    HYSafeRelease(flexSpaceItem);
    HYSafeRelease(cameraItem);
    HYSafeRelease(photoItem);
    HYSafeRelease(atContactItem);
    HYSafeRelease(emotionItem);
    HYSafeRelease(addItem);
