...
- (void)viewDidLoad
{
    ...
    QYAboutMeViewController *aboutMeCtrl = [[QYAboutMeViewController alloc] init];
    UINavigationController *navAboutMe = [[UINavigationController alloc] initWithRootViewController:aboutMeCtrl];
