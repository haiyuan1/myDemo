...
//    QYMainViewController *rootVC = [[QYMainViewController alloc] init];
//    
//    self.window.rootViewController = rootVC;
    
    QYTouchTestViewController *rootViewCtrl = [[QYTouchTestViewController alloc] init];
    self.window.rootViewController = rootViewCtrl;
    [rootViewCtrl release]; rootViewCtrl = nil;
